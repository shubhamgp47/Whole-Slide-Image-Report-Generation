...
__implemented_models = {
    ...
    'dinov2_vitl': '/home/woody/iwi5/iwi5204h/HistGen/CLAM/models/ckpts/dinov2_cpath_v1.pth',
    'uni1': 'MahmoodLab/UNI',
    'uni2': '/home/woody/iwi5/iwi5204h/UNI2_model'
}
...
def get_model(model_name, device, gpu_num):
    ...
    # our models
        ...
        from models.uni1 import build_model
        model = build_model(device, gpu_num, model_name, __implemented_models[model_name])
    elif model_name == 'uni2':
        from models.uni2 import build_model
        model = build_model(device, gpu_num, model_name, __implemented_models[model_name])
...
def get_custom_transformer(model_name):
    ...
    if model_name in ['resnet50', 'resnet101']:
        ...
        from models.uni1 import build_transform
        custom_trans = build_transform()
    elif model_name == 'uni2':
        from models.uni2 import build_transform
        custom_trans = build_transform()
